...
class AI:
    ...
    def move_parallel(self, board):
        ...
        try:
            ...
            scores = pool.map_async(unpack_get_move_score,
                                    [(self, 0), (self, 1), (self, 2), (self, 3), (self, 4), (self, 5)]).get(60)
            scores = list(scores)
    ...
    def move_serial(self, board):
        ...
        while i < 6 and not cut:
            ...
            i += 1
        print
        'Searched ', self.search_count, ' possibilities'
        return move
...
def ai_battle():
    ...
    ai_relative = AI(P2, lookahead, relative_score=True, horde=True,
